...
"[project]/app/api/credits/purchase-pack/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            if (!body.teamId || !body.amount || !body.paymentMethodId) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing required fields: teamId, amount, paymentMethodId", 400);
            }
            if (body.amount <= 0) {
            ...
            if (team.ownerId !== authContext.userId && authContext.role !== "super_admin") {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Only team owner can purchase credit packs", 403);
            }
            ...
            const updatedWallet = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].updateWalletBalance(walletId, creditsToAdd);
            if (!updatedWallet) {
            ...
            const transaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].createTransaction({
                ...
                metadata: {
                    packName: body.packName || 'Custom Pack',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49a524d3._.js.map