...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            // Get all invites (no teamId filter on main list)
            const invites = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].getInvites();
            // Filter by email, status, and other criteria in-memory
            let filtered = invites;
            // Filter by user email
            if (authContext.email) {
                filtered = filtered.filter((i)=>i.email === authContext.email || i.inviteeEmail === authContext.email);
            }
            // Filter by status if provided
            if (status) {
                filtered = filtered.filter((i)=>i.status === status);
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(filtered);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e9b8f9c4._.js.map