...
async function POST(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        ...
        `
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(emailLog, "Test email sent successfully via SMTP");
        } catch (error) {
            console.error("Email sending failed:", error);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(error.message || "Failed to send email. Check SMTP configuration.", 500);
        }
    });
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10a57c11._.js.map