    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            if (filters.search) {
                ...
                filtered = filtered.filter((u)=>u.userId.toLowerCase().includes(search) || u.email.toLowerCase().includes(search) || u.name.toLowerCase().includes(search));
            }
            // Apply pagination
            const start = (page - 1) * limit;
            const paginatedUsers = filtered.slice(start, start + limit);
            const response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaginatedResponse"])(paginatedUsers, filtered.length, page, limit);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            if (!body.email || !body.name) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing required fields: email, name", 400);
            }
            // Check if user already exists
            const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserDatabase"].getByEmail(body.email);
            if (existingUser) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("User with this email already exists", 400);
            }
            // Create user in Firestore with Firebase UID as the key
            const userId = `user_${Date.now()}`;
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserDatabase"].create(userId, {
                email: body.email,
                name: body.name,
                role: body.role || "user",
                status: "active",
            ...
            // Create audit log
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuditLogDatabase"].create({
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(user, "User created successfully");
        } catch (error) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleApiError"])(error);
        }
    }, "super_admin");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad70e532._.js.map