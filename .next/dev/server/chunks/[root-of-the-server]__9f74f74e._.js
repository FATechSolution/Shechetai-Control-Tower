    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            if (filters.search) {
                ...
                filtered = filtered.filter((a)=>a.agentId.toLowerCase().includes(search) || a.name.toLowerCase().includes(search));
            }
            const total = filtered.length;
            const start = (page - 1) * limit;
            const paginated = filtered.slice(start, start + limit);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaginatedResponse"])(paginated, total, page, limit));
        } catch (error) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            if (!body.name || !body.teamId) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing required fields: name, teamId", 400);
            }
            ...
            if (!response.ok) {
                ...
                const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentDatabase"].create({
                    name: body.name,
                    teamId: body.teamId,
                    status: body.status || "active",
                    seatUsage: body.seatUsage || {
                        used: 0,
                        cap: 0
                    },
                    createdAt: new Date().toISOString(),
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(created, "Agent created in Firebase (backend unavailable)");
            }
            const data = await response.json();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(data, "Agent created successfully");
        } catch (error) {
            console.error("Proxy Error:", error);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleApiError"])(error);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9f74f74e._.js.map