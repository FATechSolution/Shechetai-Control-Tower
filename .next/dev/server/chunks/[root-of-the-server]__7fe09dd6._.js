...
class FirestoreDatabase {
   ...
   */ static async query(collection, filters) {
        ...
        const validFilters = filters.filter((f)=>f.value !== undefined);
...
async function POST(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            let wallet = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].getWalletByTeamId(body.teamId);
            if (!wallet) {
                wallet = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].createWallet({
                    teamId: body.teamId,
                    balance: 0,
                    currency: "credits",
                    status: "active"
            ...
            const updatedWallet = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].updateWalletBalance(walletId, creditsToAdd);
            if (!updatedWallet) {
            ...
            const transaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].createTransaction({
                walletId: walletId,
                teamId: body.teamId,
                type: "purchase",
                amount: creditsToAdd,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7fe09dd6._.js.map