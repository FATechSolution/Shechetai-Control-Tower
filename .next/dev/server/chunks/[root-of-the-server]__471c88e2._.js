    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            if (filters.search) {
                ...
                filtered = filtered.filter((t)=>t.teamId.toLowerCase().includes(search) || t.name.toLowerCase().includes(search));
            }
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            if (!body.name || !body.ownerId) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing required fields: name, ownerId", 400);
            }
            ...
            if (!response.ok) {
                ...
                const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TeamDatabase"].create({
                    name: body.name,
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(created, "Team created in Firebase (backend unavailable)");
            }
            const data = await response.json();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(data, "Team created successfully");
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__471c88e2._.js.map