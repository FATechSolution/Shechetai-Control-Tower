...
"[project]/app/api/audit-logs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            const logs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getAuditLogs(filters);
            // Ensure logs is an array
            const logsArray = Array.isArray(logs) ? logs : [];
            // Apply pagination
            const start = (page - 1) * limit;
            const paginatedLogs = logsArray.slice(start, start + limit);
            const response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaginatedResponse"])(paginatedLogs, logsArray.length, page, limit);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dfa1b4fe._.js.map