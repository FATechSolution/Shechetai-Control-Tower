...
"[project]/app/api/admin/feature-flags/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async ()=>{
        try {
            const flags = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getFeatureFlags();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(flags);
        } catch (error) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            if (!body.name || !body.key) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing required fields: name, key", 400);
            }
            // Check if flag already exists
            const existingFlag = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getFeatureFlag(body.key);
            if (existingFlag) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Feature flag with this key already exists", 400);
            }
            const flag = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].createFeatureFlag({
                name: body.name,
                key: body.key,
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(flag, "Feature flag created successfully");
        } catch (error) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleApiError"])(error);
        }
    }, "super_admin");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4261aced._.js.map