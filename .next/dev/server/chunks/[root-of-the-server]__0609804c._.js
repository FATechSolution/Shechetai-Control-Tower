...
"[project]/app/api/users/[userId]/suspend/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            if (user.status === "suspended") {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("User is already suspended", 400);
            }
            const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].updateUser(userId, {
                status: "suspended"
            });
            // Create audit log
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(updatedUser, "User suspended successfully");
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0609804c._.js.map