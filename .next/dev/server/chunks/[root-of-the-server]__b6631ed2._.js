...
const Database = {
    ...
    deletePlan: (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubscriptionDatabase"].update(id, {
            status: "archived"
        }),
...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            if (!teamId) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing required parameter: teamId", 400);
            }
            ...
            const stripePaymentMethods = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2f$stripe$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listPaymentMethods"])(team.stripeCustomerId);
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(paymentMethods);
        } catch (error) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            if (!body.teamId || !body.paymentMethodId) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Missing required fields: teamId, paymentMethodId", 400);
            }
            ...
            if (!stripeCustomerId) {
                const customer = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2f$stripe$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createCustomer"])(team.ownerEmail || authContext.email, team.name, {
                    teamId: body.teamId
                });
                stripeCustomerId = customer.id;
                // Update team with Stripe customer ID
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].updateTeam(body.teamId, {
                    stripeCustomerId
                });
            }
            // Attach payment method to customer
            const { attachPaymentMethod, setDefaultPaymentMethod } = await __turbopack_context__.A("[project]/lib/stripe/stripe-server.ts [app-route] (ecmascript, async loader)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b6631ed2._.js.map