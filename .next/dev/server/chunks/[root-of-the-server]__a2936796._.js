...
async function POST(request) {
    try {
        // Get the body first to validate JSON
        let body = {};
        try {
        ...
        if (!hasSmtpConfig) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                note: "In development, you can still test the email endpoint structure. Configure SMTP to actually send emails."
            }, {
                status: 503
            });
        }
        try {
            // Dynamically import and use nodemailer directly
            ...
            const info = await transporter.sendMail({
                from: process.env.EMAIL_FROM || "noreply@shechetai.com",
                to: email,
                subject: subject,
                html: `<p>${message}</p>`
            });
            ...
            if (errorMsg.includes("connect") || errorMsg.includes("ECONNREFUSED") || errorMsg.includes("timeout")) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
                    error: `SMTP connection failed: ${errorMsg}. Please verify SMTP server is accessible.`
                }, {
                    status: 503
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a2936796._.js.map