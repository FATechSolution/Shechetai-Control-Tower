...
function TopBar({ userEmail, isSuperAdmin, onMenuToggle, isSidebarOpen }) {
    ...
    const handleLogout = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signOutUser"])();
            router.push("/login");
        } catch (error) {
...
"[project]/lib/utils/session.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSessionTimeout(enabled = true) {
    ...
    const warningRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const clearTimers = ()=>{
...
function useConcurrentSession() {
    const [hasConflict, setHasConflict] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const sessionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(generateSessionId());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
"[project]/lib/utils/network.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/ui/dialog-simple.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/ui/session-warnings.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/session.ts [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$session$2d$warnings$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/session-warnings.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function DashboardLayout({ children }) {
    const [userEmail, setUserEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("admin@shechetai.com");
    const [isSuperAdmin, setIsSuperAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    // Session management
    const { showWarning, timeLeft, extendSession } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionTimeout"])(true);
    const { hasConflict } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useConcurrentSession"])();
    const isOffline = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$network$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useOnlineStatus"])();
    // Get current section from pathname
    const currentSection = pathname?.split('/')[2] || 'overview';
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Check if user is authenticated
        const { onAuthChange } = __turbopack_context__.r("[project]/lib/firebase/client.ts [app-ssr] (ecmascript)");
    ...
    const handleLogout = async ()=>{
        const { signOutUser } = __turbopack_context__.r("[project]/lib/firebase/client.ts [app-ssr] (ecmascript)");
        await signOutUser();
        router.push("/login");
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$session$2d$warnings$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SessionTimeoutWarning"], {
                isOpen: showWarning,
                timeLeft: timeLeft,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$session$2d$warnings$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ConcurrentSessionWarning"], {
                isOpen: hasConflict
            }, void 0, false, {
                fileName: "[project]/app/dashboard/layout.tsx",
                lineNumber: 76,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$session$2d$warnings$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OfflineWarning"], {
                isOffline: !isOffline
            }, void 0, false, {
                fileName: "[project]/app/dashboard/layout.tsx",
                lineNumber: 77,
...
//# sourceMappingURL=_f81f6072._.js.map