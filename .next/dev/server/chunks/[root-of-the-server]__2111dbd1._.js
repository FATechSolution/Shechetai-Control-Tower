...
"[project]/app/api/invites/[inviteId]/accept/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
async function POST(request, context) {
    try {
        ...
        // Get invite details
        const invite = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].getInviteById(inviteId);
        if (!invite) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invite not found", 404);
        }
        // Check if invite is still pending
        if (invite.status !== "pending") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invite has already been used or cancelled", 400);
        }
        // Check if invite has expired
        if (new Date(invite.expiresAt) < new Date()) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invite has expired", 400);
        }
        ...
        if (authHeader?.startsWith("Bearer ")) {
            try {
                const admin = (await __turbopack_context__.A("[externals]/firebase-admin [external] (firebase-admin, cjs, async loader)")).default;
        ...
        if (!userId) {
            ...
            if (existingUser) {
                ...
                const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].createUser(tempUserId, {
                    email: invite.email,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].addTeamMember({
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Database"].updateInvite(inviteId, {
            status: "accepted",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2111dbd1._.js.map