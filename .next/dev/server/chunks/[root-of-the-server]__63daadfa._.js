...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            const contracts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getContracts(teamId);
            // Enrich contracts with calculated endDates
            const enrichedContracts = contracts.map((contract)=>{
                if (!contract.endDate && contract.startDate) {
                    contract.endDate = calculateEndDate(contract.startDate, contract.billingCycle);
                }
                return contract;
            });
            // Apply pagination
            const start = (page - 1) * limit;
            const paginatedContracts = enrichedContracts.slice(start, start + limit);
            const response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaginatedResponse"])(paginatedContracts, enrichedContracts.length, page, limit);
...
async function POST(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            const contract = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].createContract({
                teamId: body.teamId,
                ...
                endDate: body.endDate || calculateEndDate(body.startDate || new Date().toISOString(), body.billingCycle),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63daadfa._.js.map