...
class SubscriptionPlanDatabase {
    static collection = "subscriptionPlans";
    static async getAll() {
        return FirestoreDatabase.getAll(this.collection);
    }
    static async getById(planId) {
        return FirestoreDatabase.getById(this.collection, planId);
    }
    static async create(data) {
        return FirestoreDatabase.create(this.collection, data);
    }
    static async update(planId, data) {
        return FirestoreDatabase.update(this.collection, planId, data);
    }
    static async delete(planId) {
        return FirestoreDatabase.delete(this.collection, planId);
    }
}
...
class ProductDatabase {
    ...
    static async getById(productId) {
        return FirestoreDatabase.getById(this.collection, productId);
    }
    static async create(data) {
        return FirestoreDatabase.create(this.collection, data);
    }
    static async update(productId, data) {
        return FirestoreDatabase.update(this.collection, productId, data);
    }
    static async delete(productId) {
        return FirestoreDatabase.delete(this.collection, productId);
    }
}
class WhiteLabelDomainDatabase {
    static collection = "whiteLabelDomains";
    static async getAll() {
        return FirestoreDatabase.getAll(this.collection);
    }
    static async getById(domainId) {
        return FirestoreDatabase.getById(this.collection, domainId);
    }
    static async getByTeam(teamId) {
        return FirestoreDatabase.query(this.collection, [
            {
    ...
    static async update(domainId, data) {
        return FirestoreDatabase.update(this.collection, domainId, data);
    }
    static async delete(domainId) {
        return FirestoreDatabase.delete(this.collection, domainId);
    }
}
...
const Database = {
    ...
    getPlans: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubscriptionPlanDatabase"].getAll(),
    getPlanById: (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubscriptionPlanDatabase"].getById(id),
    createPlan: (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubscriptionPlanDatabase"].create(data),
    updatePlan: (id, data)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubscriptionPlanDatabase"].update(id, data),
    deletePlan: (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubscriptionPlanDatabase"].delete(id),
    // Payment method operations
    getPaymentMethods: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PaymentMethodDatabase"].getAll ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PaymentMethodDatabase"].getAll() : Promise.resolve([]),
    ...
    setDefault: (id, teamId)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PaymentMethodDatabase"].setDefault(id),
    ...
    getAuditLogs: (filters)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuditLogDatabase"].getAll(),
    ...
    getFeatureFlag: (key)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FeatureFlagDatabase"].getById(key),
    ...
    updateFeatureFlag: (id, data)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FeatureFlagDatabase"].update(id, data),
    deleteFeatureFlag: (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FeatureFlagDatabase"].delete(id),
    ...
    getSettings: (category)=>Promise.resolve([]),
    updateSetting: (key, value, userId)=>Promise.resolve(null),
    getUsageReports: (teamId)=>Promise.resolve([]),
    createUsageReport: (data)=>Promise.resolve(null),
    // Invoice operations
    getInvoices: (teamId)=>Promise.resolve([]),
    createInvoice: (data)=>Promise.resolve(null)
};
;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/app/api/payment-methods/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            let teamId = searchParams.get("teamId") || undefined;
            // If no teamId provided, get user's first team
            if (!teamId) {
                // Try to get user's first team
                const teams = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getTeams();
                const userTeams = teams.filter((t)=>t.ownerId === authContext.userId);
                if (userTeams.length > 0) {
                    teamId = userTeams[0].teamId;
                } else {
                    // If user has no teams, use user ID as default team identifier
                    teamId = `team_${authContext.userId}`;
                }
            }
            // Get payment methods from database
            const paymentMethods = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getPaymentMethods();
            const teamMethods = paymentMethods.filter((pm)=>pm.teamId === teamId);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(teamMethods || []);
        } catch (error) {
...
async function POST(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req, authContext)=>{
        try {
            ...
            // Get teamId from body or use first team of the user
            let teamId = body.teamId;
            if (!teamId) {
                // Try to get user's first team from database
                const teams = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getTeams();
                const userTeams = teams.filter((t)=>t.ownerId === authContext.userId || t.members && t.members.includes(authContext.userId));
                if (userTeams.length === 0) {
                    // If user has no teams, create a default team or use a generic teamId
                    // Use userId as default team for standalone users
                    teamId = `team_${authContext.userId}`;
                } else {
                    teamId = userTeams[0].teamId;
                }
            }
            // Validate team exists (unless it's a user default team)
            if (!teamId.startsWith("team_")) {
                const team = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].getTeamById(teamId);
                if (!team) {
            ...
            const paymentMethod = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].createPaymentMethod({
                teamId,
                type: body.type || "card",
                last4: body.last4,
                brand: body.brand,
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$database$2d$bridge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Database"].createAuditLog({
                ...
                resourceId: paymentMethod?.paymentMethodId,
                details: {
                    teamId,
                    type: body.type
                }
            });
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(paymentMethod, "Payment method added successfully");
        } catch (error) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleApiError"])(error);
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e169db2b._.js.map