...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            const configs = null //await Database.getWhiteLabelConfigs(teamId)
            ;
...
async function POST(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(request, async (req)=>{
        try {
            ...
            const team = null //await Database.getTeamById(body.teamId)
            ;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba08ebaf._.js.map